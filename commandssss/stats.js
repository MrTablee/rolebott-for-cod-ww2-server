...
message.channel.send(`<@${mentionedID}>'s stats are:\nCurrent Level: ${usrLevel}\nCurrent Points: ${usrPoints}\nAwards:${usrAwards}\nZombies slain: ${usrKills}\nXP: ${usrXP}\nCoins: ${usrCoins}\nXP needed to level up: ${coinsNeeded} XP\nReward Level: ${points.rewardLevel}\nRewards Available: ${points.rewardsAvailable}\nDaily cooldown: ${Math.floor((points.dailyCooldown - (new Date().getTime()))/3600000)} Hours\nXP boost level: ${points.xpBoostLevel}\nCoin boost level: ${points.coinBoostLevel}`)
    });
}
